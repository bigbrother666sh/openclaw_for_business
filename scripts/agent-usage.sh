...
#
# 用法:
#   ./scripts/agent-usage.sh                    # 所有 Agent 累计
#   ./scripts/agent-usage.sh --agent hrbp       # 指定 Agent
#   ./scripts/agent-usage.sh --period daily     # 按日统计（默认 7 天）
#   ./scripts/agent-usage.sh --period weekly    # 按周统计
#   ./scripts/agent-usage.sh --period monthly   # 按月统计
#   ./scripts/agent-usage.sh --days 30          # 指定天数
#   ./scripts/agent-usage.sh --agent all --period daily --days 14
set -e
